...
class Sudoku:
    ...
    def removable(self, i, j, test_num) -> (bool, int):
        ...
        if condition == z3.sat:
            ...
            if condition == z3.unknown:
                ...
                self.write_to_smt_and_sudoku_file((i, j), test_num, condition,False)
                    ...
                    while check != z3.sat:
                        ...
                        if check == z3.unknown:
                            ...
                            if self._hard_smt_logPath:
                                self.write_to_smt_and_sudoku_file((i, j), tryVal, check, True)
                            else:
                            ...
                            if self._nums[r][c] == 0:
                                ...
                                if condition == z3.sat:
                                    ...
                                    if condition == z3.unknown:
                                        ...
                                        if self._hard_smt_logPath:
                                            self.write_to_smt_and_sudoku_file((r, c), num, check, True)
                                        else:
                                            print("TimeOut and a logPath is not provided")
    ...
    def generate_smt_with_additional_constraint(self, index: (int, int), try_val: int, is_sat: bool, assert_equals: bool,
                                                smt_dir: str) -> str:
        """
